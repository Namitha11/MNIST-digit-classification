...
data = MNIST('C:/Users/namithakamiti/Downloads/Handwritten-Digit-Recognition-using-Deep-Learning-main/Handwritten-Digit-Recognition-using-Deep-Learning-main/dataset')
